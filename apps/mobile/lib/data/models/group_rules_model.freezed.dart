...
@JsonKey(fromJson: _toInt) int get eligibleCount; bool get isReadyToStart; bool get isWaitingForMembers;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GroupStartReadinessModel&&(identical(other.eligibleCount, eligibleCount) || other.eligibleCount == eligibleCount)&&(identical(other.isReadyToStart, isReadyToStart) || other.isReadyToStart == isReadyToStart)&&(identical(other.isWaitingForMembers, isWaitingForMembers) || other.isWaitingForMembers == isWaitingForMembers));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,eligibleCount,isReadyToStart,isWaitingForMembers);

@override
String toString() {
  return 'GroupStartReadinessModel(eligibleCount: $eligibleCount, isReadyToStart: $isReadyToStart, isWaitingForMembers: $isWaitingForMembers)';
}
...
@useResult
$Res call({
@JsonKey(fromJson: _toInt) int eligibleCount, bool isReadyToStart, bool isWaitingForMembers
});
...
/// Create a copy of GroupStartReadinessModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? eligibleCount = null,Object? isReadyToStart = null,Object? isWaitingForMembers = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: _toInt)  int eligibleCount,  bool isReadyToStart,  bool isWaitingForMembers)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GroupStartReadinessModel() when $default != null:
return $default(_that.eligibleCount,_that.isReadyToStart,_that.isWaitingForMembers);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: _toInt)  int eligibleCount,  bool isReadyToStart,  bool isWaitingForMembers)  $default,) {final _that = this;
switch (_that) {
case _GroupStartReadinessModel():
return $default(_that.eligibleCount,_that.isReadyToStart,_that.isWaitingForMembers);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: _toInt)  int eligibleCount,  bool isReadyToStart,  bool isWaitingForMembers)?  $default,) {final _that = this;
switch (_that) {
case _GroupStartReadinessModel() when $default != null:
return $default(_that.eligibleCount,_that.isReadyToStart,_that.isWaitingForMembers);case _:
  return null;
...
class _GroupStartReadinessModel implements GroupStartReadinessModel {
  const _GroupStartReadinessModel({@JsonKey(fromJson: _toInt) required this.eligibleCount, required this.isReadyToStart, required this.isWaitingForMembers});
...
/// Create a copy of GroupStartReadinessModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? eligibleCount = null,Object? isReadyToStart = null,Object? isWaitingForMembers = null,}) {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,groupId,contributionAmount,frequency,customIntervalDays,graceDays,fineType,fineAmount,payoutMode,winnerSelectionTiming,const DeepCollectionEquality().hash(paymentMethods),roundSize,requiredToStart,readiness,createdAt,updatedAt);

@override
String toString() {
  return 'GroupRulesModel(groupId: $groupId, contributionAmount: $contributionAmount, frequency: $frequency, customIntervalDays: $customIntervalDays, graceDays: $graceDays, fineType: $fineType, fineAmount: $fineAmount, payoutMode: $payoutMode, winnerSelectionTiming: $winnerSelectionTiming, paymentMethods: $paymentMethods, roundSize: $roundSize, requiredToStart: $requiredToStart, readiness: $readiness, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
/// Create a copy of GroupRulesModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? groupId = null,Object? contributionAmount = null,Object? frequency = null,Object? customIntervalDays = freezed,Object? graceDays = null,Object? fineType = null,Object? fineAmount = null,Object? payoutMode = null,Object? winnerSelectionTiming = null,Object? paymentMethods = null,Object? roundSize = null,Object? requiredToStart = null,Object? readiness = null,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_self.copyWith(
...
switch (_that) {
case _GroupRulesModel():
return $default(_that.groupId,_that.contributionAmount,_that.frequency,_that.customIntervalDays,_that.graceDays,_that.fineType,_that.fineAmount,_that.payoutMode,_that.winnerSelectionTiming,_that.paymentMethods,_that.roundSize,_that.requiredToStart,_that.readiness,_that.createdAt,_that.updatedAt);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,groupId,contributionAmount,frequency,customIntervalDays,graceDays,fineType,fineAmount,payoutMode,winnerSelectionTiming,const DeepCollectionEquality().hash(_paymentMethods),roundSize,requiredToStart,readiness,createdAt,updatedAt);
