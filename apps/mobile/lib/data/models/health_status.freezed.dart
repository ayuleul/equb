...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HealthStatus&&(identical(other.status, status) || other.status == status)&&(identical(other.checks, checks) || other.checks == checks)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp));
}
...
@override
String toString() {
  return 'HealthStatus(status: $status, checks: $checks, timestamp: $timestamp)';
}
...
class _HealthStatus implements HealthStatus {
  const _HealthStatus({required this.status, required this.checks, required this.timestamp});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HealthStatus&&(identical(other.status, status) || other.status == status)&&(identical(other.checks, checks) || other.checks == checks)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp));
}
