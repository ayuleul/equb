...
mixin _$UpdateGroupRulesRequest {
 ...
 int get contributionAmount;@JsonKey(unknownEnumValue: GroupRuleFrequencyModel.unknown) GroupRuleFrequencyModel get frequency; int? get customIntervalDays; int get graceDays;@JsonKey(unknownEnumValue: GroupRuleFineTypeModel.unknown) GroupRuleFineTypeModel get fineType; int get fineAmount;@JsonKey(unknownEnumValue: GroupRulePayoutModeModel.unknown) GroupRulePayoutModeModel get payoutMode;@JsonKey(unknownEnumValue: WinnerSelectionTimingModel.unknown) WinnerSelectionTimingModel get winnerSelectionTiming;@JsonKey(fromJson: _paymentMethodsFromJson, toJson: _paymentMethodsToJson) List<GroupPaymentMethodModel> get paymentMethods; bool get requiresMemberVerification; bool get strictCollection;@JsonKey(unknownEnumValue: StartPolicyModel.unknown) StartPolicyModel get startPolicy; int get roundSize;@JsonKey(toJson: _nullableDateToIsoString) DateTime? get startAt; int? get minToStart;
...
/// Create a copy of UpdateGroupRulesRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? contributionAmount = null,Object? frequency = null,Object? customIntervalDays = freezed,Object? graceDays = null,Object? fineType = null,Object? fineAmount = null,Object? payoutMode = null,Object? winnerSelectionTiming = null,Object? paymentMethods = null,Object? requiresMemberVerification = null,Object? strictCollection = null,Object? startPolicy = null,Object? roundSize = null,Object? startAt = freezed,Object? minToStart = freezed,}) {
...
as bool,startPolicy: null == startPolicy ? _self.startPolicy : startPolicy // ignore: cast_nullable_to_non_nullable
as StartPolicyModel,roundSize: null == roundSize ? _self.roundSize : roundSize // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int contributionAmount, @JsonKey(unknownEnumValue: GroupRuleFrequencyModel.unknown)  GroupRuleFrequencyModel frequency,  int? customIntervalDays,  int graceDays, @JsonKey(unknownEnumValue: GroupRuleFineTypeModel.unknown)  GroupRuleFineTypeModel fineType,  int fineAmount, @JsonKey(unknownEnumValue: GroupRulePayoutModeModel.unknown)  GroupRulePayoutModeModel payoutMode, @JsonKey(unknownEnumValue: WinnerSelectionTimingModel.unknown)  WinnerSelectionTimingModel winnerSelectionTiming, @JsonKey(fromJson: _paymentMethodsFromJson, toJson: _paymentMethodsToJson)  List<GroupPaymentMethodModel> paymentMethods,  bool requiresMemberVerification,  bool strictCollection, @JsonKey(unknownEnumValue: StartPolicyModel.unknown)  StartPolicyModel startPolicy,  int roundSize, @JsonKey(toJson: _nullableDateToIsoString)  DateTime? startAt,  int? minToStart)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateGroupRulesRequest() when $default != null:
return $default(_that.contributionAmount,_that.frequency,_that.customIntervalDays,_that.graceDays,_that.fineType,_that.fineAmount,_that.payoutMode,_that.winnerSelectionTiming,_that.paymentMethods,_that.requiresMemberVerification,_that.strictCollection,_that.startPolicy,_that.roundSize,_that.startAt,_that.minToStart);case _:
  return orElse();
...
class _UpdateGroupRulesRequest implements UpdateGroupRulesRequest {
  const _UpdateGroupRulesRequest({required this.contributionAmount, @JsonKey(unknownEnumValue: GroupRuleFrequencyModel.unknown) required this.frequency, this.customIntervalDays, required this.graceDays, @JsonKey(unknownEnumValue: GroupRuleFineTypeModel.unknown) required this.fineType, required this.fineAmount, @JsonKey(unknownEnumValue: GroupRulePayoutModeModel.unknown) required this.payoutMode, @JsonKey(unknownEnumValue: WinnerSelectionTimingModel.unknown) required this.winnerSelectionTiming, @JsonKey(fromJson: _paymentMethodsFromJson, toJson: _paymentMethodsToJson) required final  List<GroupPaymentMethodModel> paymentMethods, required this.requiresMemberVerification, required this.strictCollection, @JsonKey(unknownEnumValue: StartPolicyModel.unknown) required this.startPolicy, required this.roundSize, @JsonKey(toJson: _nullableDateToIsoString) this.startAt, this.minToStart}): _paymentMethods = paymentMethods;
...
@override final  int roundSize;
@override@JsonKey(toJson: _nullableDateToIsoString) final  DateTime? startAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,contributionAmount,frequency,customIntervalDays,graceDays,fineType,fineAmount,payoutMode,winnerSelectionTiming,const DeepCollectionEquality().hash(_paymentMethods),requiresMemberVerification,strictCollection,startPolicy,roundSize,startAt,minToStart);
