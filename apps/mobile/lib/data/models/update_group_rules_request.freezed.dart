...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,contributionAmount,frequency,customIntervalDays,graceDays,fineType,fineAmount,payoutMode,winnerSelectionTiming,const DeepCollectionEquality().hash(paymentMethods),startPolicy,roundSize,startAt,minToStart);

@override
String toString() {
  return 'UpdateGroupRulesRequest(contributionAmount: $contributionAmount, frequency: $frequency, customIntervalDays: $customIntervalDays, graceDays: $graceDays, fineType: $fineType, fineAmount: $fineAmount, payoutMode: $payoutMode, winnerSelectionTiming: $winnerSelectionTiming, paymentMethods: $paymentMethods, startPolicy: $startPolicy, roundSize: $roundSize, startAt: $startAt, minToStart: $minToStart)';
}
...
/// Create a copy of UpdateGroupRulesRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? contributionAmount = null,Object? frequency = null,Object? customIntervalDays = freezed,Object? graceDays = null,Object? fineType = null,Object? fineAmount = null,Object? payoutMode = null,Object? winnerSelectionTiming = null,Object? paymentMethods = null,Object? startPolicy = null,Object? roundSize = null,Object? startAt = freezed,Object? minToStart = freezed,}) {
...
as List<GroupPaymentMethodModel>,startPolicy: null == startPolicy ? _self.startPolicy : startPolicy // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int contributionAmount, @JsonKey(unknownEnumValue: GroupRuleFrequencyModel.unknown)  GroupRuleFrequencyModel frequency,  int? customIntervalDays,  int graceDays, @JsonKey(unknownEnumValue: GroupRuleFineTypeModel.unknown)  GroupRuleFineTypeModel fineType,  int fineAmount, @JsonKey(unknownEnumValue: GroupRulePayoutModeModel.unknown)  GroupRulePayoutModeModel payoutMode, @JsonKey(unknownEnumValue: WinnerSelectionTimingModel.unknown)  WinnerSelectionTimingModel winnerSelectionTiming, @JsonKey(fromJson: _paymentMethodsFromJson, toJson: _paymentMethodsToJson)  List<GroupPaymentMethodModel> paymentMethods, @JsonKey(unknownEnumValue: StartPolicyModel.unknown)  StartPolicyModel startPolicy,  int roundSize, @JsonKey(toJson: _nullableDateToIsoString)  DateTime? startAt,  int? minToStart)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateGroupRulesRequest() when $default != null:
return $default(_that.contributionAmount,_that.frequency,_that.customIntervalDays,_that.graceDays,_that.fineType,_that.fineAmount,_that.payoutMode,_that.winnerSelectionTiming,_that.paymentMethods,_that.startPolicy,_that.roundSize,_that.startAt,_that.minToStart);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int contributionAmount, @JsonKey(unknownEnumValue: GroupRuleFrequencyModel.unknown)  GroupRuleFrequencyModel frequency,  int? customIntervalDays,  int graceDays, @JsonKey(unknownEnumValue: GroupRuleFineTypeModel.unknown)  GroupRuleFineTypeModel fineType,  int fineAmount, @JsonKey(unknownEnumValue: GroupRulePayoutModeModel.unknown)  GroupRulePayoutModeModel payoutMode, @JsonKey(unknownEnumValue: WinnerSelectionTimingModel.unknown)  WinnerSelectionTimingModel winnerSelectionTiming, @JsonKey(fromJson: _paymentMethodsFromJson, toJson: _paymentMethodsToJson)  List<GroupPaymentMethodModel> paymentMethods, @JsonKey(unknownEnumValue: StartPolicyModel.unknown)  StartPolicyModel startPolicy,  int roundSize, @JsonKey(toJson: _nullableDateToIsoString)  DateTime? startAt,  int? minToStart)  $default,) {final _that = this;
switch (_that) {
case _UpdateGroupRulesRequest():
return $default(_that.contributionAmount,_that.frequency,_that.customIntervalDays,_that.graceDays,_that.fineType,_that.fineAmount,_that.payoutMode,_that.winnerSelectionTiming,_that.paymentMethods,_that.startPolicy,_that.roundSize,_that.startAt,_that.minToStart);}
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,contributionAmount,frequency,customIntervalDays,graceDays,fineType,fineAmount,payoutMode,winnerSelectionTiming,const DeepCollectionEquality().hash(_paymentMethods),startPolicy,roundSize,startAt,minToStart);
