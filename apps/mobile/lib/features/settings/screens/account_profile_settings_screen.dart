...
class AccountProfileSettingsScreen extends ConsumerStatefulWidget {
  const AccountProfileSettingsScreen({super.key});

  @override
  ConsumerState<AccountProfileSettingsScreen> createState() =>
      _AccountProfileSettingsScreenState();
}

class _AccountProfileSettingsScreenState
    extends ConsumerState<AccountProfileSettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return KitScaffold(
      appBar: const KitAppBar(title: 'My profile', showAvatar: false),
      child: ListView(
        children: [
          KitCard(
            child: Column(
